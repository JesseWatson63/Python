...
def read_global():
    print("From inside local scope of read_global(), value is:", value)
    
def shadow_global():
    value = - 10
    print("From inside local scope of shadow_global(), value is", value)
...
# main
# value is a global variable becasue we're in the global scope here
value = 10
